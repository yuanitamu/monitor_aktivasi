...
function drawSmallTickMarks(options) {
	...
	var tickvalue = options.levelRadius - 12,
	    iTick = 0,
	...
	for (iTick =2.5; iTick < 185; iTick += 17.5) {
...
function drawLargeTickMarks(options) {
	...
	for (iTick = 12; iTick < 185; iTick += 17.5) {
...
function drawTextMarkers(options) {
	...
	for (iTick = 179; iTick > 0; iTick -= 17.6) {
...
function drawNeedle(options) {
	...
	*/
	...
	var iSpeedAsAngle = convertSpeedToAngle(options),
        ...
        gaugeOptions = options.gaugeOptions,
        innerTickX = gaugeOptions.radius - (Math.cos(iSpeedAsAngleRad)),
        innerTickY = gaugeOptions.radius - (Math.sin(iSpeedAsAngleRad)),
...
function buildOptionsAsJSON(canvas, iSpeed) {
	...
	*/
	...
	return {
		...
		levelRadius: radius-10,//garis warna hijau merah
		gaugeOptions: {
			center:	{
				X: centerX,
				Y: centerY
