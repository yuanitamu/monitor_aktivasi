                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                  <form action="<?php echo "".base_url()."index.php/cso/p_tambah"?>" name="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Total SO Open" name="topen"/>
                                        </div>
										<div class="form-group">
                                            <label>Total SO Close</label>
                                            <input class="form-control" placeholder="Total SO Close" name="tclose" />
                                        </div>
										<div class="form-group">
                                            <label>Total SO Cancel</label>
                                            <input class="form-control" placeholder="Total SO Cancel" name="tcancel" />
                                        </div>
