                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                             Tabel Bulanan Pembangunan Lastmile & Jaringan Per Bulan
                        </div>
...
<?php
function set_keuangan_screen($plj,$group,$view){
		?>						
                    <div class="table-responsive" style="padding-top:15px;">
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                ...
                                <th>No.</th>
                                <th>Tanggal</th>
                                <th>Realisasi Delivery <br />Penyelesaian SO <br />(Hari)</th>
                                <th>Target Realisasi<br /> Delivery <br />Penyelesaian SO <br />(Hari)</th>											
                                <th>Realisasi <br />Penyelesaian SO <br />(%)</th>
                                <th>Target Realisasi <br />Penyelesaian SO <br />(%)</th>											
                                <th>#</th>
								<th>#</th>
                                </tr>
                            </thead>
							<tbody>
								...
								<td><?php
									...
									echo form_hidden('idPlj',$dt->idPlj,'idPlj="idPlj"');?>
